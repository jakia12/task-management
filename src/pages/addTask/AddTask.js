    ...
    return (
        <section className="lg:py-20 py-14">
            <div className="container mx-auto max-w-7xl w-full px-6">
                <div className="mx-auto md:max-w-xl w-full shadow-lg shadow-gray-100 py-7">
                    <h2 className="text-3xl mt-6 font-medium text-center text-dark">
                        Add Your Task Here
                    </h2>
                    <form onSubmit={handleSubmit(handleAddTask)} className="flex flex-col gap-4 text-left">
                        ...
                        <div className="mb-1">
                            ...
                            <input className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="multiple_files" type="file" placeholder=' Upload Task Image for a preview' multiple
                                {...register("image", {
